...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(78, 18);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(180, 18);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(78, 98);
			...
			this->label2->Location = System::Drawing::Point(132, 21);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(42, 12);
			this->label2->TabIndex = 2;
			this->label2->Text = L"スピード";
			// 
			// label3
			// 
			this->label3->AutoSize = true;
			this->label3->Location = System::Drawing::Point(30, 101);
			...
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(180, 58);
			...
			this->Label4->Location = System::Drawing::Point(92, 61);
...
#pragma endregion
	...
	//(1)接続
	private: Boolean OpenInterface(String^ port, String^ speed, String^ timeout) {
				 Boolean ret = false;

				 try
				 {
					 ReceiveTimeout = Convert::ToInt64(timeout) * 1000;
					 SerialPort = gcnew System::IO::Ports::SerialPort();				//シリアルポートオブジェクトを作成
